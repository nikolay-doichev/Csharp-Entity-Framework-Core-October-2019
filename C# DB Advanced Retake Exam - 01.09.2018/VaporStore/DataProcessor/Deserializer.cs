    ...
    public static class Deserializer
	{
		public static string ImportGames(VaporStoreDbContext context, string jsonString)
		{
            ...
            foreach (var gameDto in gamesDto)
            {
                ...
                var genre = GetGanre(context, gameDto.Genre);
		...
		{
            var xmlSerilizer = new XmlSerializer(typeof(ImportPurchaseDto[]),
                new XmlRootAttribute("Purchases"));

            var purchasesDto = (ImportPurchaseDto[])xmlSerilizer.Deserialize(new StringReader(xmlString));
        ...
        private static Genre GetGanre(VaporStoreDbContext context, string genreDto)
        {
